...
function challengePage(title, body, extraStyles = "") {
  return htmlPage(title, `      body { font-family: system-ui, sans-serif; padding: 2rem; background: #f8fafc; color: #0f172a; }\n      .demo { max-width: 960px; margin: 0 auto; }\n${extraStyles}`, body);
}
