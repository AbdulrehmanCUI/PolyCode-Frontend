...
} from "../data/rustFundamentalsCurriculum";
...
const LEARNING_PATH = [
  {
    level: "Beginner",
    chapters: ["rust-getting-started"],
    color: "#ce422b",
    summary: "Hello world, variables, mutability, and Rust's core data types.",
  },
  {
    level: "Intermediate",
    chapters: ["rust-functions-control-flow", "rust-ownership-basics"],
    color: "#f59e0b",
    summary: "Functions, control flow, and the ownership rules that make Rust unique.",
  },
  {
    level: "Advanced",
    chapters: ["rust-structs-enums", "rust-error-handling"],
    color: "#7c3aed",
    summary: "Structs, enums, pattern matching, Option, and Result-based error handling.",
  },
  {
    level: "Expert",
    chapters: ["rust-modules-traits-capstone"],
    color: "#dc2626",
    summary: "Modules, traits, generics, and a capstone library-system project.",
  },
];
...
export default function RustFundamentalsHub() {
  ...
  const earnedXP = RUST_FUNDAMENTALS_LESSONS.filter(
  ...
  return (
    <div className="oops-hub matplotlib-hub">
      <div className="oops-hero matplotlib-hero">
        ...
        <div className="oops-hero-badge">RUST · CORE COURSE</div>
        ...
        <p className="oops-hero-sub">
          Learn Rust from the ground up — variables, ownership, structs,
          enums, and error handling. {RUST_FUNDAMENTALS_CHAPTERS.length}{" "}
          chapters, {RUST_FUNDAMENTALS_LESSONS.length} lessons, hands-on Rust
          challenges.
        </p>
        ...
        <div className="oops-tool-panel oops-tool-panel-main">
          ...
          <div className="oops-search-row">
            <input
              ...
              placeholder="Search ownership, structs, traits..."
              aria-label="Search Rust Fundamentals lessons"
            />
            <div
              className="oops-filter-tabs"
              aria-label="Filter Rust Fundamentals lessons"
            >
              {[
                ["all", "All"],
                ["todo", "To do"],
      ...
      <section className="matplotlib-learn-path" aria-label="Learning path">
        <div className="matplotlib-path-label">
          ...
          <small>
            {RUST_FUNDAMENTALS_CHAPTERS.length} chapters ·{" "}
            {RUST_FUNDAMENTALS_LESSONS.length} lessons
          </small>
        </div>
        <div className="matplotlib-path-grid">
          {LEARNING_PATH.map((stage) => {
            const stageChapters = RUST_FUNDAMENTALS_CHAPTERS.filter((ch) =>
