...
// challenge in the Rust curriculum data files). This mirrors the other
// Rust course components (Fundamentals, Collections, Memory, Concurrency)
// so no new data format is introduced.
//
